...
const cert = {
    ...
    key: fs.readFileSync('./resourcePrivateKey.key', 'utf8'),
    cert: fs.readFileSync('./resourceCert.crt', 'utf8')
};
const app = express();
...
httpsServer.listen(8081, () => {
    ...
    console.log('Also available: https://CA-LAB22-EPO:8081/');
});
 ...
 * Common Name (e.g. server FQDN or YOUR name) []:CA-LAB22-EPO
 * Email Address []:
 */
